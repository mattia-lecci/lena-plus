...
public:
  ...
  // TODO in case remove - added in order to avoid overloading confusion when performing callbacks
  void ActivateDedicatedEpsBearerSchedule (Ptr<NetDevice> ueDevice, EpsBearer bearer, Ptr<EpcTft> tft);
  /**
...
private:
  ...
  /**
   * The `ConnectionReleaseEnabled` attribute. If true, the eNB can send
